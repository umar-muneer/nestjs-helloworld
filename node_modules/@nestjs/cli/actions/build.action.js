...
class BuildAction extends abstract_action_1.AbstractAction {
    constructor() {
        ...
        this.watchCompiler = new watch_compiler_1.WatchCompiler(this.pluginsLoader, this.tsConfigProvider);
    ...
    runBuild(inputs, options, watchMode, isDebugEnabled = false, onSuccess) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.assetsManager.copyAssets(configuration, appName, outDir);
            if (isWebpackEnabled) {
